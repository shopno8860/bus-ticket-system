...
export const endpoints = {
  ...
  dashboard: {
    ...
    extendSeatLocks: '/dashboard/bookings/lock/extend',
    ...
    boardingPoints: '/dashboard/boarding-points',
    boardingPoint: (id) => `/dashboard/boarding-points/${id}`,
    droppingPoints: '/dashboard/dropping-points',
    droppingPoint: (id) => `/dashboard/dropping-points/${id}`,
